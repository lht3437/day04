...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="type" class="form-control" id="txt_search_type" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						<input type="hidden" name="did" id="hidden_txt_did" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>设备类型：</td>
								<td>
								     <select class="" name="name" id = "name" aria-required="true" required>
								...
								<td>设备状态：</td>
								<td>
									<select class="" name="status" id = "status" aria-required="true" required>
										<option value="">---请选择---</option>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_did").value='';
	...
	function initEditUser(getSelection){
		$('#hidden_txt_did').val(getSelection.did);
		$('#type').val(getSelection.type);
		$('#price').val(getSelection.price);
		$('#ram').val(getSelection.ram);
